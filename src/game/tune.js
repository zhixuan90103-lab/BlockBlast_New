...
export const TUNE_FIELDS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        key: 'DEAL_CLEAR_OFFER_RETRY_MAX',
        label: '清屏失败续推次数',
        min: 1,
        max: 12,
        step: 1,
      ...
      {
        key: 'DEAL_CLEAR_FINISHER_FILL_MAX',
        label: '收官强清填充上限',
        min: 0.15,
        max: 0.5,
        step: 0.01,
      ...
      {
        key: 'DEAL_EARLY_FORCE_FULL_CLEAR',
        label: '前期强制搜全清',
        min: 0,
        max: 1,
        step: 1,
      ...
      {
        key: 'DEAL_EARLY_CLEAR_GUIDE_MUL',
        label: '前期盘面引导强度',
        min: 0,
        max: 1.2,
        step: 0.05,
