...
> 文档整理：**2026-07-31**（设置 UI · 投影跟本体/卡边/斜向 · 渲染池化 · 笔记 **§14**）
...
| **踩坑与迭代史（项目笔记）** | [PROJECT-HISTORY.md](./PROJECT-HISTORY.md)（最新 **§14**） |
...
| [GHOST-DESIGN.md](./GHOST-DESIGN.md) | **投影完整规格 SSOT**（跟本体 · 卡边 1.3 · 斜向过滤 · open/edge） | **改投影行为时必更** |
...
| 消行视觉 / 屏震 / debris / 投影绘制 / 对象池 | `src/game/view.js` · `block-mesh.js` · `game.js` clearFx |
